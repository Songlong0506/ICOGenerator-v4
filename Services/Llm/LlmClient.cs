...
public class LlmClient : ILlmClient
{
    ...
    // Internal so the MAF native-path instrumentation (AgentRunInstrumentationChatClient) caps each
    // round with the same logic instead of duplicating it.
    internal static int ResolveMaxTokens(AiModel model, int promptTokens)
    {
