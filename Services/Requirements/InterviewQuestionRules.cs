...
/// (<c>requirement-coverage.v3.md</c>: *"Người dùng nói rõ luồng này không có ngoại lệ nào"*, *"nói rõ
...
{
    /// <summary>
    /// Nhãn nhóm (theo <c>requirement-coverage.v3.md</c>) của các câu BẮT BUỘC đứng một mình trong lượt.
