...
/// Eval/judge.v1.md), khoan dung với code-fence/văn dẫn quanh JSON (<see cref="LlmJson"/>). Điểm ngoài 1–5
/// bị kẹp về biên thay vì loại bỏ (model đôi khi trả 0/6 cho ý "tệ nhất/tốt nhất").
/// </summary>
public static class EvalJudgeParser
{
    public static bool TryParse(string? responseText, out int score, out string reasoning)
    {
        ...
        var parsed = LlmJson.TryDeserialize<JudgeVerdict>(responseText);
