...
| `BusinessAnalyst/interview-outlook.v1.md` | "Triển vọng phỏng vấn": `openQuestions` / `workedExamples` (ảnh chụp trạng thái) + `scopeAdditions` (DELTA phạm vi màn hình, ghép thẳng vào bảng màn hình ở trạng thái chờ duyệt) |
