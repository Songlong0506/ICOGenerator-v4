...
| `BusinessAnalyst/interview-outlook.v1.md` | "Triển vọng phỏng vấn": `openQuestions` / `workedExamples` — hai ảnh chụp trạng thái, chắt lại sau MỖI lượt chat vì tồn đọng câu hỏi được nạp thẳng vào ngữ cảnh lượt sau |
