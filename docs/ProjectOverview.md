...
| Security/RBAC/Audit | `AccountController`, `RolesController`, `AuditController` | `Configuration` (settings đăng nhập), `Application/Roles`, `Application/Audit` | `AppUser`, `AppUserRole`, `RolePermission`, `AuditLog` |
