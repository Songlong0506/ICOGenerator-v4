...
- `Services/Evals/` — prompt eval harness: golden set + runner + LLM-judge + lịch định kỳ + chốt chặn hồi quy (ARCHITECTURE 5.15).
- `Services/Quality/` — ma trận truy vết yêu cầu → story/code/test (ARCHITECTURE 5.17).
