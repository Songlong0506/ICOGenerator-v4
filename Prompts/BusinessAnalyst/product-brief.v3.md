...
- **DÙNG KHỐI "Trạng thái đã chắt từ hội thoại" LÀM DANH SÁCH KIỂM (nếu đầu vào có):** nó gồm *Điều đã chốt*, *Ví dụ đã xác nhận* và *Điểm cần làm rõ còn tồn đọng* — đều được chắt ra từ chính hội thoại này, không phải thông tin mới. Trước khi trả JSON, soát từng dòng: mỗi *Điều đã chốt* phải nằm ở đâu đó trong tài liệu; mỗi *Ví dụ đã xác nhận* phải có quy tắc tương ứng và tài liệu không được nói ngược lại nó. Một quyết định được chốt từ giữa buổi rồi không ai nhắc lại vẫn là yêu cầu — đó chính là loại bị rơi nhiều nhất.
