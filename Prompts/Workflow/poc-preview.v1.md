...
- Nội dung gần như TỰ CHỨA: ngoại lệ DUY NHẤT là bộ Bootstrap Icons mà shell đã nhúng sẵn qua <link> (được dùng class `bi bi-...`). KHÔNG link/nhúng thêm bất kỳ CSS hay JS framework ngoài nào khác (không Angular/Material/Bootstrap CSS/jQuery...). Chỉ dùng CSS/JS đã có sẵn trong file.
